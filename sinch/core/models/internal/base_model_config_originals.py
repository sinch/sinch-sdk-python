...
## FOR SMS , the API is snake_case both the request and the response allows extra fields
## for the request no conversion is done
## for the response unknown fields are converted from camelCase to snake_case
## No alias needed for the request or the response
...
## Numbers - the API is camelCase for both the request and the response
## Uses alias for the request and the response
## Extra fields are converted from snake_case to camelCase for the request and from camelCase to snake_case for the response
...
## NUMBER LOOKUP - the API is camelCase for both the request and the response
## Uses alias for the request and the response
## Extra fields are converted from camelCase to snake case for the response
import re
from typing import Any
from pydantic import BaseModel, ConfigDict
...
## CONVERSATION - the API is snake_case for both the request and the response
## Extra fields are converted from camelCase to snake_case for the response and the request
