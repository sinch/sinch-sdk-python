...
class HTTPTransport(ABC):
    ...
    def _send_with_retries(
        ...
        """
        Sends a request, retrying rate-limited responses according to
        :attr:`Configuration.retry_manager`.
        ...
        return self.sinch.configuration.retry_manager.execute(call)
