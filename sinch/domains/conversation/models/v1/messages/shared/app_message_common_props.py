...
from sinch.domains.conversation.models.v1.messages.internal.channel_specific_message_internal import (
    ChannelSpecificMessageInternal,
)
...
class AppMessageCommonProps(BaseModelConfigurationResponse):
    ...
    explicit_channel_omni_message: Optional[
        Dict[str, OmniMessageOverrideInternal]
    ] = Field(
        default=None,
    ...
    channel_specific_message: Optional[
        Dict[str, ChannelSpecificMessageInternal]
    ] = Field(
        default=None,
