...
from sinch.domains.conversation.models.v1.messages.shared.flow_action_payload_internal import (
    FlowActionPayloadInternal,
)


class FlowChannelSpecificMessageInternal(ChannelSpecificCommonProps):
    ...
    flow_action_payload: Optional[FlowActionPayloadInternal] = None
