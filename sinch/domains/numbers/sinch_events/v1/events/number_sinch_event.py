...
from sinch.domains.numbers.sinch_events.v1.internal import WebhookEvent


class NumberSinchEvent(WebhookEvent):
    ...
    status: Optional[Union[Literal["SUCCEEDED", "FAILED"], StrictStr]] = None
