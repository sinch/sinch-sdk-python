...
def endpoint(request_data):
    return DeleteServiceEndpoint("test_project_id", request_data)
...
def test_handle_response_expects_no_content(endpoint, mock_response):
    """Test that a successful delete returns None."""
