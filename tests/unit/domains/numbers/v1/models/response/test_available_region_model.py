...
@pytest.fixture
def test_data():
    return {"regionCode": "US", "regionName": "United States", "types": ["MOBILE", "LOCAL", "TOLL_FREE"]}
...
def test_available_region_expects_empty_types_list():
    ...
    """
    empty_types_list = {"regionCode": "US", "regionName": "United States", "types": []}
...
def test_available_region_expects_validation_error_on_non_string_fields():
    ...
    """
    invalid_data = {"regionCode": 123, "regionName": "United States", "types": ["MOBILE"]}
