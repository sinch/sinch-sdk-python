...
def test_update_number_configuration_request_valid_expects_parsed_response():
    ...
    data = {
        ...
        "smsConfiguration": {"servicePlanId": "string", "campaignId": "YOUR_campaignId_from_TCR"},
    ...
    assert request.sms_configuration == {"servicePlanId": "string", "campaignId": "YOUR_campaignId_from_TCR"}
    assert request.voice_configuration == {"type": "RTC", "appId": "YOUR_Voice_appId"}
...
def test_update_number_configuration_request_missing_phone_number_expects_error():
    ...
    """
    data = {"displayName": "Test Number", "callbackUrl": "https://www.your-callback-server.com/callback"}
