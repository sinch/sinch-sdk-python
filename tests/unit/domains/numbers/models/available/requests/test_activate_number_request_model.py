...
def test_activate_number_request_expects_snake_case_input():
    ...
    data = {
        ...
        "sms_configuration": {"service_plain_id": "YOUR_SMS_servicePlanId"},
        "voice_configuration": {
    ...
    assert request.sms_configuration == {"service_plain_id": "YOUR_SMS_servicePlanId"}
...
def test_activate_number_request_expects_camel_case_input():
    ...
    data = {
        ...
        "smsConfiguration": {"servicePlainId": "YOUR_SMS_servicePlanId"},
        "voice_configuration": {
    ...
    assert request.phone_number == "+1234567890"
    assert request.sms_configuration == {"servicePlainId": "YOUR_SMS_servicePlanId"}
    assert request.voice_configuration == {
         "appId": "YOUR_voice_appID",
         "type": "RTC"
        }
...
def test_activate_number_request_expects_validation_error_for_missing_field():
    ...
    """
    data = {
        "sms_configuration": {"servicePlainId": "YOUR_SMS_servicePlanId"},
        "voice_configuration": {
            "appId": "YOUR_voice_appID",
            "type": "RTC"
         },
