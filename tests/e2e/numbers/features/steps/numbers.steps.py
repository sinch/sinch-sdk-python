...
def step_check_number_availability(context, phone_number):
    try:
        context.response = context.sinch.numbers.available.check_availability(phone_number)
...
def step_rent_any_number(context):
    context.response = context.sinch.numbers.available.rent_any(
        region_code='US',
        type_='LOCAL',
...
def step_rent_specific_number(context, phone_number):
    context.response = context.sinch.numbers.available.activate(
...
def step_when_update_phone_number(context, phone_number):
    context.response = context.sinch.numbers.active.update(
        phone_number=phone_number,
...
def step_when_retrieve_phone_number(context, phone_number):
    try:
        context.response = context.sinch.numbers.active.get(
            phone_number=phone_number,
        )
    except NumberNotFoundException as e:
        context.error = e
...
def step_when_release_phone_number(context, phone_number):
    context.response = context.sinch.numbers.active.release(
        phone_number=phone_number
    )
